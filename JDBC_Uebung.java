	...
	public static void main(String[] args) {
		...
		try{
			...
			/*
					...
					+ " (jeweils mit einem Absatz getrennt) für den Motorradfahrer ein: MotorradfahrerID,"
					+ " Vorname, Nachname, Motorrad, Geschlecht [w, m]");					
			System.out.println("Geben sie bitte die Daten in der folgenden Reihenfolge"
					+ " (jeweils mit einem Absatz getrennt) für die Strecke ein: StreckenID,"
					+ " Startort, Startort-PLZ, Startland, Zielort, Zielort-PLZ, Zielland"); 
			System.out.println("Geben sie bitte die Daten in der folgenden Reihenfolge"
					+ " (jeweils mit einem Absatz getrennt) für die Ausfahrt ein:\nMotorradfahrerID,"
					+ " StreckenID, Datum [JJJJ-MM-TT hh:mm:ss], zusätzliche Beschreibung"); */
		...
		//	stmt.executeUpdate(sql2);
			...
			stmt.executeUpdate(InsertMotorradfahrer(3, "Köllö", "S", "Yamaha XVS1300A", "m"));
			 */
			/*
			 ...
			 */
			/*
			stmt.executeUpdate(InsertStrecke(1, "Mutters", "6162", "AUT", "Götzens", "6091", "AUT"));
			stmt.executeUpdate(InsertStrecke(2, "Götzens", "6091", "AUT", "Bolzano", "1111", "ITA"));
